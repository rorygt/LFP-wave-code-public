function [firingRate, nActive, totTime] = calculateFiringRate(spikeMatrix, halfWindowSize, Fs, groupFiringFlag, singleUnitFlag, minRate)
...
totTime = (halfWindowSize+1) : (size(spikeMatrix,2)-halfWindowSize-1);
...
if groupFiringFlag
    ...
    firingRate = sum(firingRate(activeCh,:));
end